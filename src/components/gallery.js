...
const Gallery = () => {
    ...
    return (_jsxs(Box, { sx: { padding: 4 }, children: [_jsxs(Box, { display: "flex", justifyContent: "space-between", alignItems: "center", children: [_jsx(Typography, { variant: "h3", gutterBottom: true, children: "Gallery" }), _jsx(Link, { component: "button", variant: "body2", onClick: () => navigate('/galleryPage'), style: { fontWeight: 'bold', fontSize: '1.5rem' }, children: "View All" })] }), _jsx(Typography, { variant: "body1", paragraph: true, children: "Explore my collection of artworks and photography." }), _jsx(Grid, { container: true, spacing: 4, children: galleryData.map((artwork) => (_jsx(Grid, { item: true, xs: 12, sm: 6, md: 4, children: _jsx(Card, { children: _jsx(CardMedia, { component: "img", alt: artwork.title, height: "300", image: artwork.imageUrl, title: artwork.title, sx: {
