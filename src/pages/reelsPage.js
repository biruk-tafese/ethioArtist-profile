...
export default function ReelsPage() {
    ...
    return (_jsxs("div", { children: [_jsx(Typography, { variant: "h4", align: "center", sx: { marginTop: 9 }, children: "Reels" }), _jsx(TextField, { variant: "outlined", fullWidth: true, placeholder: 'Search like `movies, tv, music`', onChange: handleSearchChange, sx: { marginBottom: 2, marginTop: 4, maxWidth: '600px', mx: 'auto' } }), _jsx(Grid, { container: true, spacing: 2, sx: { paddingTop: 2 }, children: filteredVideos.map((video, index) => (_jsx(Grid, { item: true, xs: 12, sm: 6, md: 4, lg: 3, children: _jsx(CardMedia, { component: "video", src: video, style: { width: '100%', cursor: 'pointer', borderRadius: '8px' }, onClick: () => handleImageClick(video), controls: true }) }, index))) }), _jsx(Dialog, { open: open, onClose: handleClose, fullWidth: true, maxWidth: "md", children: _jsxs(DialogContent, { children: [_jsx(IconButton, { edge: "end", color: "inherit", onClick: handleClose, "aria-label": "close", style: { position: 'absolute', right: 8, top: 8 }, children: _jsx(CloseIcon, {}) }), selectedVideo && (_jsx(CardMedia, { component: "video", src: selectedVideo, style: { width: '100%', borderRadius: '8px' }, controls: true }))] }) })] }));
}
